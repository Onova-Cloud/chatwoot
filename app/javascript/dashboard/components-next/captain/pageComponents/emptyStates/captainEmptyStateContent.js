...
export const documentsList = [
  ...
  },
  {
    ...
    content:
      'Step-by-step guide for automating ticket assignments and improving support workflow in Omni.',
  ...
  },
  {
    ...
    content:
      'How to efficiently create, manage, and resolve tickets in Omni.',
...
export const responsesList = [
  {
    ...
    id: 87,
    question: 'Why is my Messenger in Omni deactivated?',
    status: 'pending',
    assistant: {
      account_id: 1,
      config: { product_name: 'Omni' },
  ...
  },
  {
    ...
    id: 88,
    question: 'How do I integrate WhatsApp with Omni?',
    assistant: {
      account_id: 2,
      config: { product_name: 'Omni' },
  ...
  },
  {
    ...
    id: 89,
    question: 'How can I reset my password in Omni?',
    assistant: {
      account_id: 3,
      config: { product_name: 'Omni' },
  ...
  },
  {
    ...
    id: 90,
    question: 'How do I enable dark mode in Omni?',
    assistant: {
      account_id: 4,
      config: { product_name: 'Omni' },
  ...
  },
  {
    ...
    id: 91,
    question: 'How do I add a new team member in Omni?',
    assistant: {
      account_id: 5,
      config: { product_name: 'Omni' },
  ...
  },
  {
    account_id: 6,
    answer:
      "Campaigns in Omni allow you to send targeted messages to specific user segments. You can create them in the 'Campaigns' section.",
    created_at: 1736283380,
    id: 92,
    question: 'What are campaigns in Omni?',
    assistant: {
      account_id: 6,
      config: { product_name: 'Omni' },
